...
![程序的演示图片13](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/13.png)

## 
![程序的演示图片14](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/14.png)


##  设备共享 
  
![程序的演示图片15](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/15.png)

##  设备设置 
![程序的演示图片16](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/16.png)

##  设备管理
![程序的演示图片17](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/17.png)

##  添加设备（扫二维码）
![程序的演示图片18](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/18.png)

##  不符合ID号格式返回的错误信息
![程序的演示图片19](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/19.png)

##  查询公司后台数据库这个ID是否存在，不存在的返回信息
![程序的演示图片20](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/20.png)

##  添加设备（手动添加设备ID）
![程序的演示图片21](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/21.png)

##  手动添加设备ID格式错误
![程序的演示图片22](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/22.png)

##  向设备添加WIFI模块
![程序的演示图片23](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/23.png)


##  WIFI配置失败
![程序的演示图片24](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/24.png)


##  WIFI配置过程
![程序的演示图片25](https://github.com/ChampionDragon/AfterSaleService/blob/master/UI/25.png)
